...
const translations = {
  'sr': {
    title: 'Pet biznisi na opštini Čukarica',
    subtitle: 'Poslovanja sa kućnim ljubimcima u opštini Čukarica',
  ...
  'en': {
    title: 'Pet Businesses in Čukarica Municipality',
    subtitle: 'Pet businesses in Čukarica Municipality',
...
export default function CukaricaPage() {
  ...
  return (
    <main>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container-custom">
          <h2 className="text-2xl font-bold mb-6">Pet biznisi Čukarica – Najbolje prodavnice, saloni i veterinari</h2>
          <div className="prose max-w-none">
            <p>Pronađite sve pet shopove, salone za šišanje, veterinare i pansione za kućne ljubimce na opštini Čukarica. Najveći izbor i najbolje ocene na jednom mestu. WikiPets – Vaš vodič za ljubimce u ovom delu Beograda!</p>
          </div>
        </div>
      </section>
    </main>
