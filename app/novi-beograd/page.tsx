...
const translations = {
  'sr': {
    title: 'Pet biznisi na opštini Novi Beograd',
    subtitle: 'Poslovanja sa kućnim ljubimcima u opštini Novi Beograd',
  ...
  'en': {
    title: 'Pet Businesses in Novi Beograd Municipality',
    subtitle: 'Pet businesses in Novi Beograd Municipality',
...
export default function NoviBeogradPage() {
  ...
  const knownStreets = [
    'Bulevar Zorana Đinđića', 'Bulevar Mihajla Pupina', 'Bulevar Arsenija Čarnojevića',
    'Jurija Gagarina', 'Gandijeva', 'Goce Delčeva', 'Omladinskih brigada',
    'Antifašističke borbe', 'Đorđa Stanojevića', 'Palmira Toljatija',
    'Bulevar Milutina Milankovića', 'Bulevar umetnosti', 'Bulevar AVNOJ-a',
    'Severni bulevar', 'Partizanske avijacije', 'Dr Ivana Ribara',
    'Narodnih heroja', 'Tošin bunar', 'Pariske komune', 'Bulevar Ivana Milutinovića',
    'Bulevar Nikole Tesle', 'Bulevar heroja sa Košara', 'Bulevar Evrope',
    'Bulevar Vudro Vilson', 'Bulevar Vojvode Mišića', 'Bulevar Vojvode Stepe',
    'Bulevar despota Stefana', 'Bulevar kralja Aleksandra', 'Bulevar oslobođenja'
  ];
  const businesses = allBusinesses.filter(b =>
    (
      b.municipality === 'Novi Beograd' ||
      (b.address && b.address.toLowerCase().includes('novi beograd')) ||
    ...
    <main>
      ...
      <div className="relative h-[500px] overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="https://images.unsplash.com/photo-1518717758536-85ae29035b6d?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80"
      ...
      <section className="py-12 bg-gray-50">
        <div className="container-custom">
          <h2 className="text-2xl font-bold mb-6">Pet biznisi Novi Beograd – Najbolje prodavnice, saloni i veterinari</h2>
          <div className="prose max-w-none">
            <p>Pronađite sve pet shopove, salone za šišanje, veterinare i pansione za kućne ljubimce na opštini Novi Beograd. Najveći izbor i najbolje ocene na jednom mestu. WikiPets – Vaš vodič za ljubimce na Novom Beogradu!</p>
          </div>
        </div>
      </section>
    </main>
