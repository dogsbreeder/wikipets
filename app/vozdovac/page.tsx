...
const translations = {
  'sr': {
    title: 'Pet biznisi na opštini Voždovac',
    subtitle: 'Poslovanja sa kućnim ljubimcima u opštini Voždovac',
  ...
  'en': {
    title: 'Pet Businesses in Voždovac Municipality',
    subtitle: 'Pet businesses in Voždovac Municipality',
...
export default function VozdovacPage() {
  ...
  const knownStreets = [
    'Vojvode Stepe', 'Bulevar oslobođenja', 'Medaković', 'Stepa Stepanović',
    'Jajinci', 'Banjica', 'Kumodraž', 'Braće Jerković', 'Save Maškovića',
    'Paunova', 'Vitanovačka', 'Vojvode Toze', 'Vojvode Skopljanca',
    'Vojvode Vlahovića', 'Vojvode Brane', 'Vojvode Bogdana', 'Vojvode Milenka',
    'Vojvode Mišića', 'Vojvode Putnika', 'Vojvode Tankosića', 'Vojvode Uroša',
    'Vojvode Vuka', 'Vojvode Živojina', 'Kružni put', 'Gospodara Vučića',
    'Zaplanjska', 'Ignjata Joba', 'Pive Karamatijevića', 'Kumodraška',
    'Bulevar JNA', 'Bulevar Peka Dapčevića', 'Bulevar vojvode Mišića'
  ];

  const businesses = allBusinesses.filter(b =>
    (
      b.municipality === 'Voždovac' ||
      (b.address && b.address.toLowerCase().includes('vozdovac')) ||
  ...
  return (
    <main>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container-custom">
          <h2 className="text-2xl font-bold mb-6">Pet biznisi Voždovac – Najbolje prodavnice, saloni i veterinari</h2>
          <div className="prose max-w-none">
            <p>Pronađite sve pet shopove, salone za šišanje, veterinare i pansione za kućne ljubimce na opštini Voždovac. Najveći izbor i najbolje ocene na jednom mestu. WikiPets – Vaš vodič za ljubimce na Voždovcu!</p>
          </div>
        </div>
      </section>
    </main>
