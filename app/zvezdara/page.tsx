...
const translations = {
  'sr': {
    title: 'Pet biznisi na opštini Zvezdara',
    subtitle: 'Poslovanja sa kućnim ljubimcima u opštini Zvezdara',
  ...
  'en': {
    title: 'Pet Businesses in Zvezdara Municipality',
    subtitle: 'Pet businesses in Zvezdara Municipality',
...
export default function ZvezdaraPage() {
  ...
  const knownStreets = [
    'Bulevar kralja Aleksandra', 'Ruzveltova', 'Vojislava Ilića', 'Maksima Gorkog',
    'Đeram', 'Cvetkova pijaca', 'Mirijevo', 'Učiteljsko naselje', 'Slavujev venac',
    'Milana Rakića', 'Koste Abraševića', 'Preševska', 'Zvezdarska šuma',
    'Volgina', 'Ljube Didića', 'Vladetina', 'Ćirila i Metodija',
    'Gospodara Vučića', 'Severni bulevar', 'Bulevar Mije Kovačevića'
  ];
  const businesses = allBusinesses.filter(b =>
    (
      b.municipality === 'Zvezdara' ||
      (b.address && b.address.toLowerCase().includes('zvezdara')) ||
  ...
  return (
    <main>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container-custom">
          <h2 className="text-2xl font-bold mb-6">Pet biznisi Zvezdara – Najbolje prodavnice, saloni i veterinari</h2>
          <div className="prose max-w-none">
            <p>Pronađite sve pet shopove, salone za šišanje, veterinare i pansione za kućne ljubimce na opštini Zvezdara. Najveći izbor i najbolje ocene na jednom mestu. WikiPets – Vaš vodič za ljubimce na Zvezdari!</p>
          </div>
        </div>
      </section>
    </main>
